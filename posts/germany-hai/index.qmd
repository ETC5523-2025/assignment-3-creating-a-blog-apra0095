...
The pattern is clearly summarised in @tbl-breakdown . It confirms while UTI dominate the case numerically, HAP and BSI still drive the majority of DALYs. This finding emphasize a prevention strategy should focus not only on frequent infections, but also disease that cause severe effects afterwards.

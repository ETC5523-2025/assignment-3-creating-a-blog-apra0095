...
The pattern is clearly summarized in @tbl-breakdown . It confirms while UTI dominate the case numerically, HAP and BSI still drive the majority of DALYs. This finding emphasize a prevention strategy should focus not only on frequent infections, but also disease that cause severe effects afterwards.
...
#| message: false
#| warning: false
#| tbl-cap: Burden of healthcare-associated infections by type, Germany PPS 2011 (Median Point Estimate, 95% UI)
